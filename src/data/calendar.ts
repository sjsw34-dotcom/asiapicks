...
export const CALENDAR: CalendarEntry[] = [
  ...
  },
  {
    ...
    kind: "new",
    season: "December 2026 to January 2027 (Cheonggyecheon; FUN SEOUL lists \"December, planned\" as of 2026-09-24)",
    draftBy: "2026-11-28",
    publishBy: "2026-12-05",
    note: "Dates are announced late: the 2025 edition was announced on 26 November for a 12 December start. Draft as soon as the Seoul Tourism Organization publishes the dates; never from a previous year.",
  },
  {
    topic: "Busan Fireworks Festival 2026",
    path: "/korea/busan/busan-fireworks-festival",
    kind: "new",
    season: "7 November 2026 (Gwangalli, Igidae, Dongbaekseom; confirmed on the official site 2026-09-24)",
    draftBy: "2026-10-05",
    publishBy: "2026-10-12",
    note: "Drafted 2026-09-24 for 3 October.",
  },
  {
    topic: "Busan Fireworks Festival 2026: add this year's road closures and subway measures",
    path: "/korea/busan/busan-fireworks-festival",
    kind: "refresh",
    season: "7 November 2026",
    draftBy: "2026-10-27",
    publishBy: "2026-11-03",
    note: "The article gives the 2025 transport plan as the pattern. Busan publishes the year's plan shortly before the festival; replace it then.",
  },
  {
